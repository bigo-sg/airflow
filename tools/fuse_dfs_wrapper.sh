...
export FUSEDFS_PATH="/data1/zhangzhibiao/hadoop-3.1.0-src/hadoop-hdfs-project/hadoop-hdfs-native-client/src/main/native/build"
export LIBHDFS_PATH="$HADOOP_HOME/lib/native/"
